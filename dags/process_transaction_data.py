...
class User:
    ...
    def validate(self):
        # Validate phoneNumber (assuming it should follow a specific pattern)
        if self.phoneNumber and not self.validate_phone_number(self.phoneNumber):
            raise ValueError("Invalid phone number format")

        # Validate that nTransactions is a non-negative integer
    ...
    def validate_phone_number(phone_number: str) -> bool:
        # Example: Simple validation to check if the phone number contains only digits
        # You can implement more complex validation based on your requirements
